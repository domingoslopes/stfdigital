...
public class DocumentoUnitTests {
	...
	public void criaDocumentoValido() {
		Documento documento = new Documento(new DocumentoId(1L), "0a1b2c3d4e5f6g7h8i9j", 1);
	...
	public void criaDocumentoComIdNulo() {
		new Documento(null, "0a1b2c3d4e5f6g7h8i9j", 1);
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void criaDocumentoComNumeroConteudoVazio() {
		new Documento(new DocumentoId(1L), "", 1);
	}
	
	@Test(expected=NullPointerException.class)
	public void criaDocumentoComNumeroConteudoNulo() {
		new Documento(new DocumentoId(1L), null, 1);
	}
	
	@Test
	public void comparaDocumentosIguais() {
		Documento documento1 = new Documento(new DocumentoId(1L), "0a1b2c3d4e5f6g7h8i9j", 1);
		Documento documento2 = new Documento(new DocumentoId(1L), "0a1b2c3d4e5f6g7h8i9j", 1);
	...
	public void comparaDocumentosDiferentes() {
		Documento documento1 = new Documento(new DocumentoId(1L), "0a1b2c3d4e5f6g7h8i9j", 1);
		Documento documento2 = new Documento(new DocumentoId(2L), "a0b1c2d3e4f5g6h7i8j9", 1);
