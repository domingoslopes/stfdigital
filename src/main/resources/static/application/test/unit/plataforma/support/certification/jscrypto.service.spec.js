...
(function() {
	...
	describe('Service: JsCrypto', function() {
		...
		var hexStringToUint8Array = function(hexString) {
		...
		var hexToBase64Url = function(val) {
			return Base64URL.stringify(hexStringToUint8Array(val));
		};
		
		var modulus = '';
		var publicExponent = '010001';
		
		var privateExponent = '';
		var primeP = '';
		var primeQ = '';
		var exponentP = '';
		var exponentQ = '';
		var coefficient = '';
		
		var privateKeyAsJwk = {
			kty: 'RSA',
			alg: 'RS256',
			n: hexToBase64Url(modulus),
			e: hexToBase64Url(publicExponent),
			d: hexToBase64Url(privateExponent),
			p: hexToBase64Url(primeP),
			q: hexToBase64Url(primeQ),
			dp: hexToBase64Url(exponentP),
			dq: hexToBase64Url(exponentQ),
			qi: hexToBase64Url(coefficient)
		};
		...
		beforeEach(function(done) {
			...
			JsCryptoFactory.create(privateKeyAsJwk, certificate).then(function(jc) {
				jsCrypto = jc;
				finish();
			}, function(error) {
				fail(error);
		...
		it('Deveria ter construindo o JsCrypto', function() {
			expect(jsCrypto).toBeDefined();
			expect(jsCrypto.certificateAsHex()).toEqual(hexCertificate);
		});
		
		it('Deveria assinar um hash', function(done) {
