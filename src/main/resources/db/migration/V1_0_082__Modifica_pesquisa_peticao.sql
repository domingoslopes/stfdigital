...
values (plataforma.seq_criterio_pesquisa.nextval, 'Meio', '_type', 'autuacao', 'TEXTO', null, null, null);
...
insert into plataforma.criterio_pesquisa (seq_criterio_pesquisa, dsc_criterio, dsc_campo, dsc_indice, tip_criterio, dsc_api, dsc_valor, dsc_descricao)
values (plataforma.seq_criterio_pesquisa.nextval, 'Situação', 'processosWorkflow.status', 'autuacao', 'TEXTO', null, null, null);
