...
create table plataforma.segmento (seq_segmento bigint not null, nom_segmento varchar2(100) not null, seq_tipo_informacao bigint not null, constraint pk_segmento primary key (seq_segmento));
alter table plataforma.segmento add constraint uk_segm_nom_segmento unique(nom_segmento, seq_tipo_informacao);
