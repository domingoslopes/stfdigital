...
alter table plataforma.tipo_segmento add constraint uk_nom_tipo_segmento_tise unique(nom_tipo_segmento);
...
alter table plataforma.tipo_informacao add constraint uk_nom_tipo_informacao_tiin unique(nom_tipo_informacao);
...
alter table plataforma.segmento add constraint uk_nom_segmento_segm unique(nom_segmento, seq_tipo_informacao, seq_tipo_segmento);
