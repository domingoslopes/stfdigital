...
insert into plataforma.criterio_pesquisa (seq_criterio_pesquisa, dsc_criterio, dsc_campo, dsc_indice, tip_criterio) values (plataforma.seq_criterio_pesquisa.nextval, 'Identificação', 'ProcessoOriginario.identificacao', 'distribuicao', 'TEXTO');
insert into plataforma.criterio_pesquisa (seq_criterio_pesquisa, dsc_criterio, dsc_campo, dsc_indice, tip_criterio, dsc_api, dsc_valor, dsc_descricao) values (plataforma.seq_criterio_pesquisa.nextval, 'Classe', 'ProcessoOriginario.classe.sigla', 'distribuicao', 'SELECAO', '/classes','sigla', 'nome');
insert into plataforma.criterio_pesquisa (seq_criterio_pesquisa, dsc_criterio, dsc_campo, dsc_indice, tip_criterio) values (plataforma.seq_criterio_pesquisa.nextval, 'Número', 'ProcessoOriginario.numero', 'distribuicao', 'NUMERO');
