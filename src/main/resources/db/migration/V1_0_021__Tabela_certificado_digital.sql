...
alter table plataforma.certificado_digital add constraint fk_certificado_digital_cedi foreign key (seq_certificado_emissor) references plataforma.certificado_digital;
