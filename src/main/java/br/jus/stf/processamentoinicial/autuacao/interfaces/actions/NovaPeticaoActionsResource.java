...
public class NovaPeticaoActionsResource {
	...
	@ActionMapping(id = "registrar-peticao-eletronica", name = "Petição Eletrônica", resourcesMode = ResourcesMode.None)
	...
	@ActionMapping(id = "registrar-peticao-eletronica-orgao", name = "Petição Órgão", resourcesMode = ResourcesMode.None)
	public Long peticionarOrgao(RegistrarPeticaoCommand command) {			
		return peticaoServiceFacade.peticionar(command.getClasseId(), command.getPartesPoloAtivo(), command.getPartesPoloPassivo(), command.getPecas(), command.getOrgaoId());
	}
	
	@ActionMapping(id = "registrar-peticao-fisica", name = "Petição Física", resourcesMode = ResourcesMode.None)
