...
import br.jus.stf.plataforma.shared.certification.infra.itext.ITextPDFSigningStrategy;
import br.jus.stf.plataforma.shared.certification.infra.itext.PKCS7DettachedITextPDFSignatureFinisher;

public class PDFSigningSpecificationBuilder {
	
	public class PKCS7SpecBuilder {
	...
	private PKCS7SpecBuilder pkcs7SpecBuilder = new PKCS7SpecBuilder();
