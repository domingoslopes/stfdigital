...
import br.jus.stf.plataforma.pesquisas.interfaces.command.ExcluirPesquisaAvancadaCommand;
...
public class PesquisaActionResource {
	...
	public void excluir(ExcluirPesquisaAvancadaCommand command) {
		pesquisaApplicationService.excluir(command.getPesquisaId());
	}
