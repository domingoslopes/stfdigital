 ...
 */
@Component
public class V1_0_076__Adic_modelos implements SpringJdbcMigration {
	...
	private Long inserirDocumento(JdbcTemplate jdbcTemplate, String path, int quantidadePaginas) throws IOException {
		...
		jdbcTemplate.update(
		        "INSERT INTO CORPORATIVO.DOCUMENTO (SEQ_DOCUMENTO, NUM_CONTEUDO, QTD_PAGINAS, TAMANHO) VALUES (?, ?, ?, ?)",
