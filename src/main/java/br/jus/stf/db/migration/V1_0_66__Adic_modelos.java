 ...
 */
@Component
public class V1_0_66__Adic_modelos implements SpringJdbcMigration {
	...
	public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
		...
		jdbcTemplate.update(
		        "INSERT INTO CORPORATIVO.MODELO (SEQ_MODELO, NOM_MODELO, SEQ_TIPO_MODELO, SEQ_DOCUMENTO_TEMPLATE) VALUES (CORPORATIVO.SEQ_MODELO.NEXTVAL, ?, ?, ?)",
	...
	private Long inserirDocumento(JdbcTemplate jdbcTemplate, String path, int quantidadePaginas) throws IOException {
		...
		jdbcTemplate.update(
		        "INSERT INTO CORPORATIVO.DOCUMENTO (SEQ_DOCUMENTO, NUM_CONTEUDO, QTD_PAGINAS) VALUES (?, ?, ?)",
		        documentoId, conteudoId, quantidadePaginas);
		return documentoId;
	}
